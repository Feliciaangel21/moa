...
export const replayMessages = [
  ...
  { round: 0, type: 'conflict', speaker: '여기서 의견이 갈렸어요', text: '펠리시아는 경험에, 서연은 숙소 위치와 품질에 돈을 더 쓰고 싶어 해요.' },
  ...
  { round: 2, type: 'conflict', speaker: '여기서 의견이 갈렸어요', text: '서연은 좋은 위치를, 펠리시아는 숙소비를 아끼는 쪽을 더 중요하게 봐요.' },
  ...
  { round: 4, type: 'verdict', speaker: '식사 심판의 결론', text: '펠리시아와 예린의 맛집 취향, 지훈의 이자카야 취향을 함께 챙겨 이자카야 B로 정했어요.' },
